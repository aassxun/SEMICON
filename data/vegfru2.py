...
#         for batch, (data, targets, index) in pbar:#enumerate(dataloader):
#             path = os.path.join(dataloader.dataset.root, dataloader.dataset.data[index.item()])
#    image_list = train_dataloader.dataset.data
#    for i in tqdm(range(len(image_list))):
#         try:
#            img = Image.open(os.path.join('/dataset/vegfru', image_list[i])).convert('RGB')
#         except:
#             print(image_list[i])
#    print(len(image_list))
#    print(image_list[0])
    # img = Image.open('/dataset/vegfru/veg200_images/houttuynia_cordata/v_08_18_0350.jpg').convert('RGB')
    # print(img)
"""
